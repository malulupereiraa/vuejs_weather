  ...
  <div id="app" :class="typeof weather.main != 'undefined' && weather.main.temp > 16 ? 'warm' : ''">
    <main>
      <div class="search-box">
        <input type="text" name="" id="" class="search-bar" placeholder="Search..." v-model="query" @keypress="fetchWeather" />
      </div>
      ...
      <div class="weather-wrap" v-if="typeof weather.main != 'undefined'">
        ...
        <div class="weather-box">
          ...
          <div class="weather" v-html="imgWeather">{{ setWeatherIcon() }}</div>
        </div>
      </div>
    </main>
  </div>
...
export default {
  ...
  data() {
    return {
      api_key: 'cd451515a8efe3d1757d8096691ac3d8',
  ...
  methods: {
    ...
    setWeatherIcon () {
        this.imgWeather = "<img src='http://openweathermap.org/img/wn/"+ this.weather.weather[0].icon+".png' width='100'>"
    }
  }
}
</script>
